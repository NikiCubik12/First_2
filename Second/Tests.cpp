...
{
    DynamicArray <int>* arr = new DynamicArray();
...
{
    int mas[3] = {1, 2, 3};
    DynamicArray <int>* arr = new DynamicArray(mas, 3);
...
{
    int mas[3] = {1, 2, 3};
    DynamicArray <int>* arr1 = new DynamicArray(mas, 3);
    DynamicArray <int>* arr2 = new DynamicArray(arr1);
...
{
    int mas[3] = {1, 2, 3};
    LinkedList <int>* list = new LinkedList(mas, 3);
    DynamicArray <int>* arr = new DynamicArray(list);
